        ...
        try {
            ...
            if (response.status >= 300) {
                window.renderPage.modalAlert(
                    "Email incorreto ou senha inválida, tente novamente ou faça seu cadastro!",
                    "red"
                );
                return 400;
            }
            ...
            window.renderPage.modalAlert(
                `Ocorreu um erro na requisição, recarrege a página e tente novamente ou contacte o administrador! Erro: ${err}`,
                "red"
            );
            return 400;
        }
